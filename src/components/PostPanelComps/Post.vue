...
.content-panel {
    ...
    box-shadow:
        0 8px 32px var(--theme-shadow-md),
        0 0 0 1px var(--theme-border-light),
        inset 0 1px 0 var(--theme-surface-hover);
...
.title-underline {
    ...
    box-shadow: 0 2px 10px var(--theme-shadow-md);
}
...
.wave {
    ...
    width: 100px;
    height: 100px;
    border: 2px solid var(--theme-button-text);
    opacity: 0.3;
    border-radius: 50%;
...
.loading-progress {
    height: 100%;
    background: linear-gradient(90deg,
            var(--theme-button-text) 0%,
            var(--theme-button-text) 50%,
            var(--theme-button-text) 100%);
    background-size: 200% 100%;
    border-radius: 2px;
    animation: loadingProgress 1.2s cubic-bezier(0.4, 0, 0.2, 1) infinite;
    box-shadow: 0 0 10px var(--theme-button-text);
    opacity: 0.5;
}
...
.spinner-ring {
    ...
    border-right-color: var(--theme-button-text);
    opacity: 0.3;
    border-radius: 50%;
...
.transition-text {
    ...
    max-width: 80%;
    text-shadow:
        0 0 20px var(--theme-button-text),
        0 0 40px var(--theme-shadow-md);
